'''
Application of stridednet  CNN method for costum image classification 
...
print('The pakcges are imported ')
...
#plot evaluation of the model 
	
# plot the training loss and accuracy
N = args["epochs"]
plt.style.use("ggplot")
plt.figure()
plt.plot(np.arange(0, N), model_fit_generator.history["loss"], label="train_loss")
plt.plot(np.arange(0, N), model_fit_generator.history["val_loss"], label="val_loss")
plt.plot(np.arange(0, N), model_fit_generator.history["acc"], label="train_acc")
plt.plot(np.arange(0, N), model_fit_generator.history["val_acc"], label="val_acc")
